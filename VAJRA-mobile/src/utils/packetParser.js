    ...
    try {
        ...
        if (type === 'CTRL') {
            return {
                ...
                immobilizerStatus: parseInt(parts[2] || '0', 10), // Index 2 is DO1 (Immobilizer)
                ignitionStatus: parseInt(parts[3] || '0', 10),    // Index 3 is DIY (Ignition)
            };
        }
        ...
        return {
            ...
            timestamp,
            fixStatus: 1,
            ignitionStatus: parts[9] !== undefined ? parseInt(parts[9], 10) : undefined,
            immobilizerStatus: parts[10] !== undefined ? parseInt(parts[10], 10) : undefined,
            dateTime: timestamp,
